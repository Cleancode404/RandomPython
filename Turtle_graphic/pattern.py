...
def generate_random_colour( ):
    'Generate an R, G, B values randomly in range 0 to 255'
    r = randint(0, 255)
    g = randint(0, 255)
    b = randint(0, 255)
    return r, g, b
...
turtle.hideturtle()
turtle.bgcolor('black') #set screen background colour
turtle.colormode(255) #indicates RGB range from 0 to 255
turtle.speed(10)
